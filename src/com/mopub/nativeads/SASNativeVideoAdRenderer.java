...
public class SASNativeVideoAdRenderer implements MoPubAdRenderer<SASMoPubCustomEventNative.SASVideoNativeAd> {
    ...
    public View createAdView(@NonNull Context context, @Nullable ViewGroup parent) {
        ...
        final RelativeLayout.LayoutParams mediaViewLayoutParams = new RelativeLayout.LayoutParams(mainImageViewLayoutParams.width, mainImageViewLayoutParams.height);
        ...
        if (mainImageViewLayoutParams instanceof RelativeLayout.LayoutParams) {
            final RelativeLayout.LayoutParams mainImageViewRelativeLayoutParams = (RelativeLayout.LayoutParams) mainImageViewLayoutParams;
    ...
    public void renderAdView(@NonNull View view, @NonNull SASMoPubCustomEventNative.SASVideoNativeAd sasVideoNativeAd) {
        ...
        NativeRendererHelper.addTextView(sasNativeViewHolder.getTitleView(), sasVideoNativeAd.getTitle());
        NativeRendererHelper.addTextView(sasNativeViewHolder.getTextView(), sasVideoNativeAd.getText());
        NativeRendererHelper.addTextView(sasNativeViewHolder.getCallToActionView(), sasVideoNativeAd.getCallToAction());

        NativeImageHelper.loadImageView(sasVideoNativeAd.getMainImageUrl(), mainImageView);
        NativeImageHelper.loadImageView(sasVideoNativeAd.getIconImageUrl(), sasNativeViewHolder.getIconImageView());

        NativeRendererHelper.addPrivacyInformationIcon(sasNativeViewHolder.getPrivacyInformationIconImageView(),
    ...
    static class SASNativeViewHolder {
        ...
        private SASNativeViewHolder(final StaticNativeViewHolder staticNativeViewHolder, final SASNativeAdMediaView mediaView, final boolean mainImageViewInRelativeView) {
        ...
        static SASNativeViewHolder fromViewBinder(final View view, final ViewBinder viewBinder) {
